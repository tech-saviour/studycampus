...
export default function AchieversSection() {
  return (
    <section
      ...
      aria-labelledby="class-xith-heading"
    >
      {/* Page Heading */}
      <header className="text-center mb-12">
        <h1
          id="class-xith-heading"
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm">
                  {faculty.name} is an experienced mentor and subject expert,
                  known for their dedication to helping students excel in Class XI.
                </p>
              </div>
            </motion.article>
          ))}
          ...
          {achieverList.map((achiever, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm">
                  {achiever.name} has set an inspiring example through academic
                  excellence and commitment to personal growth.
                </p>
              </div>
            </motion.article>
          ))}
