...
export default function AchieversSection() {
  return (
    <section className="relative py-6 md:py-8 bg-white overflow-hidden" aria-labelledby="class-xth-heading">
      
      {/* Page Heading */}
      <header className="text-center mb-12">
        <h1 id="class-xth-heading" className="text-3xl md:text-5xl font-bold text-[#004899]">
          Class Xth
        </h1>
      </header>
      ...
      <section aria-labelledby="achievers-heading" className="mb-20">
        <h2 id="achievers-heading" className="text-2xl md:text-3xl font-bold text-[#004899] text-center py-6 md:py-8">
          Our Achievers
        </h2>
