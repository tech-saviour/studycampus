...
export default function AchieversSection() {
  return (
    <section
      ...
      aria-labelledby="class-xth-heading"
    >
      {/* Page Heading */}
      <header className="text-center mb-12">
        <h1
          id="class-xth-heading"
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm">
                  {faculty.name} brings extensive expertise and a passion for
                  education that empowers students to excel.
                </p>
              </div>
            </motion.article>
          ))}
      ...
      <section aria-labelledby="achievers-heading" className="mb-20">
        <h2
          ...
          className="text-2xl md:text-3xl font-bold text-[#004899] text-center py-6 md:py-8"
        >
          Our Achievers
        </h2>
          ...
          {achieverList.map((achiever, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm">
                  {achiever.name} has excelled in academics and exemplifies the
                  success we inspire in our students.
                </p>
              </div>
            </motion.article>
          ))}
