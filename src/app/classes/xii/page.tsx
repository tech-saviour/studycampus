...
export default function AchieversSection() {
  return (
    <section
      ...
      aria-labelledby="class-xiith-heading"
    >
      {/* Page Heading */}
      <header className="text-center mb-12">
        <h1
          id="class-xiith-heading"
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm">
                  {faculty.name} is a mentor for Class XIIth, known for excellence in teaching and inspiring students to perform their best.
                </p>
              </div>
            </motion.article>
          ))}
          ...
          {achieverList.map((achiever, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm">
                  A brief note celebrating {achiever.name}&apos;s accomplishments and
                  their academic excellence at the highest level of school education.
                </p>
              </div>
            </motion.article>
          ))}
