...
export default function AchieversSection() {
  return (
    <section className="relative py-6 md:py-8 bg-white overflow-hidden" aria-labelledby="class-xiith-heading">
      
      {/* Page Heading */}
      <header className="text-center mb-12">
        <h1 id="class-xiith-heading" className="text-3xl md:text-5xl font-bold text-[#004899]">
          Class XIIth
        </h1>
      </header>
